...
- Returned `thread` objects expose copied-history lineage with `forkedFromId` and immediate subagent control/spawn lineage with `parentThreadId`; these fields are independent.
